...
public class DlgCariPeriksaRadiologi extends javax.swing.JDialog {
    ...
    private double ttl=0,item=0,jmlperiksa=0;
    ...
    */
    ...
    private void tampil() {
        try {
            ...
            if(ttl>0){
                tabMode.addRow(new Object[]{">>","Total : "+Valid.SetAngka(ttl)+" ("+Valid.SetAngka(jmlperiksa)+" Permintaan)","","","","",""});
            }
